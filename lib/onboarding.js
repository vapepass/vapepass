...
/**
 * Welcome modal shows whenever the Dashboard loads (login, refresh, revisit).
 * Closing only hides it for the current view — persistence does not block re-display.
 * @param {string|null|undefined} storeId
