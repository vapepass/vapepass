...
const HIGHLIGHTS = [
  {
    ...
    text: 'Manage your AI shopping assistant and storefront embed.',
  },
  {
    icon: LayoutDashboard,
    title: 'Your store dashboard',
    text: 'Inventory sync, recommendations, and account settings in one place.',
  },
];

/**
 * Branded shell for store login — matches RegisterLayout visual language.
 */
export default function LoginLayout({ children, footer }) {
  return (
    <div className="login-page register-page min-h-screen flex flex-col bg-[#f6f7fb]">
      ...
      <div className="mx-auto grid w-full max-w-6xl flex-1 grid-cols-1 gap-4 px-4 py-5 sm:px-6 lg:grid-cols-[1fr_1fr] lg:gap-7 lg:py-10 lg:items-center">
        <aside
          ...
          aria-label="Welcome back to VapePass"
        >
          <div className="relative z-[1] flex h-full min-h-[32rem] flex-col justify-center gap-6 p-8 xl:p-10">
            ...
            <p className="max-w-md text-[0.95rem] leading-relaxed text-violet-200">
              Sign in to open your dashboard, manage the AI Flavor Sommelier, and keep
              recommendations synced with live inventory.
            </p>
